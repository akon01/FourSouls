 ...
 */
export declare const LifeScopeToken: InjectToken<LifeScope>;
/**
...
export interface LifeScope {
     ...
     */
    execute<T>(data: ActionData<T>, ...names: string[]): any;
    /**
     ...
     * @memberof LifeScope
     */
    routeExecute<T>(data: ActionData<T>, ...names: string[]): any;
    /**
     * register action.
     *
