...
exports["default"] = {
    ...
    PLAYER_CHANGE_LOOT_CARD_PLAYS: "$PLAYER_CHANGE_LOOT_CARD_PLAYS",
    PLAYER_CHANGE_NUM_OF_ITEMS_TO_RECHARGE: "$PLAYER_CHANGE_NUM_OF_ITEMS_TO_RECHARGE",
    PLAYER_CHANGE_EXTRA_SOULS_NEEDED_TO_WIN: "$PLAYER_CHANGE_EXTRA_SOULS_NEEDED_TO_WIN",
    CHANGE_PLAYER_ATTACKABLE: "$CHANGE_PLAYER_ATTACKABLE",
    ...
    VALIDATE: "$VALIDATE",
    //Egg Counters:
    ADD_EGG_COUNTER: "$ADD_EGG_COUNTER",
    REMOVE_EGG_COUNTER: "$REMOVE_EGG_COUNTER"
};
