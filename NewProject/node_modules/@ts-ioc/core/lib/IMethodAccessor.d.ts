 ...
 */
export declare const MethodAccessorToken: InjectToken<IMethodAccessor>;
/**
...
export interface IMethodAccessor {
     ...
     * @memberof IMethodAccessor
     */
    syncInvoke<T>(target: any, propertyKey: string, instance: any, ...providers: ParamProviders[]): any;
    /**
