...
export default {
  ...
  MONSTERGETDAMAGED: "$MONSTERGETDAMAGED",
  MONSTERGAINHP: "$MONSTERGAINHP",
  MONSTERGAINDMG: "$MONSTERGAINDMG",
  MONSTERGAINROLLBONUS: "$MONSTERGAINROLLBONUS",
  MOVECARD: "$MOVECARD",
  ...
  DRAWCARD: '$DRAWCARD',
  DECKADDTOTOP: "$DECKADDTOTOP",
  DECKADDTOBOTTOM: "$DECKADDTOBOTTOM",
  //
  ...
  SETMONEY: "$SETMONEY",
  PLAYERGAINHP: "$PLAYERGAINHP",
  PLAYERGETHIT: "$PLAYERGETHIT",
  PLAYERGAINDMG: "$PLAYERGAINDMG",
  PLAYERGAINROLLBONUS: "$PLAYERGAINROLLBONUS",
  PLAYERGAINATTACKROLLBONUS: "$PLAYERGAINATTACKROLLBONUS",
  PLAYERGAINFIRSTATTACKROLLBONUS: "$PLAYERGAINFIRSTATTACKROLLBONUS",
  PLAYERRECHARGEITEM: "$PLAYERRECHARGEITEM",
  PLAYERLOSELOOT: "$PLAYERLOSELOOT",
  PLAYERGETLOOT: "$PLAYERGETLOOT",
  //
