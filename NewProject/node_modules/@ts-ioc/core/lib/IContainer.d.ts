import { Type, Token, Factory, SymbolType, Modules, LoadType, ReferenceToken, RefTokenFac, RefTarget, ClassType, InstanceFactory } from './types';
 ...
 */
export declare const ContainerToken: InjectToken<IContainer>;
/**
 * resove way
 *
 * @export
...
export interface IContainer extends IMethodAccessor, IResolverContainer {
    ...
    */
     ...
     * @memberof IContainer
     */
    iteratorServices<T>(express: (tk: ClassType<T>, fac: InstanceFactory<T>, resolvor?: IResolver, ...providers: ParamProviders[]) => void | boolean, type: ClassType<T> | ((token: ClassType<T>) => boolean), resway?: ResoveWay, ...providers: ParamProviders[]): void;
    /**
    ...
    * @memberof IContainer
    */
    iteratorServices<T>(express: (tk: ClassType<T>, fac: InstanceFactory<T>, resolvor?: IResolver, ...providers: ParamProviders[]) => void | boolean, type: Token<T> | ((token: ClassType<T>) => boolean), target: Token<any> | Token<any>[], resway?: ResoveWay, ...providers: ParamProviders[]): void;
    /**
    ...
    * @memberof IContainer
    */
    iteratorServices<T>(express: (tk: ClassType<T>, fac: InstanceFactory<T>, resolvor?: IResolver, ...providers: ParamProviders[]) => void | boolean, type: Token<T> | ((token: ClassType<T>) => boolean), target: Token<any> | Token<any>[], both: boolean, resway?: ResoveWay, ...providers: ParamProviders[]): void;
    /**
     * register type.
     *
     * @template T
