...
@ccclass('ModelingClayEffect')
export class ModelingClayEffect extends Effect {
  effectName = "ModelingClayEffect";
  ...
  async doEffect(
    ...
    copyCardComp.cardName = "Modeling Clay(" + copyCardComp.cardName + ")"
