...
@ccclass('PlayerIsKilledAfterBeingAttacked')
export class PlayerIsKilledAfterBeingAttacked extends Condition {
  event = PASSIVE_EVENTS.PLAYER_KILLED_IN_BATTLE
  @property
  isSpecificPlayer = false;
  @property({
    type: Node,
    visible: function (this: PlayerIsKilledAfterBeingAttacked) {
      return this.isSpecificPlayer
    }
  })
  specificPlayer: Node | null = null

  @property({ visible: function (this: PlayerIsKilledAfterBeingAttacked) { return !this.isOnlyCardOwner } })
  isNotCardOwner = false;

  @property({ visible: function (this: PlayerIsKilledAfterBeingAttacked) { return !this.isNotCardOwner } })
