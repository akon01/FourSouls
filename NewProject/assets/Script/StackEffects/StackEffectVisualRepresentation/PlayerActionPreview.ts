...
export default class PlayerActionPreview extends StackEffectPreview {
    ...
    setStackEffect(stackEffect: StackEffectInterface) {
        ...
        if (stackEffect instanceof StartTurnLoot) {
            ...
            this.flavorTextLable.string = stackEffect.turnPlayer.name + ` is going to loot 1 for turn.`
            ...
            this.flavorTextLable.string = stackEffect.playerWhoBuys.name + ` is going to buy ${stackEffect.itemToPurchase.name}`
            ...
            this.flavorTextLable.string = stackEffect.playerToDie.name + ` is going to die`
            ...
            this.flavorTextLable.string = stackEffect.playerToPay.name + ` is going to pay death penalties`
            ...
            this.flavorTextLable.string = player.name + ` is going to roll a dice`
            ...
            this.nameLable.string = player.name
            this.flavorTextLable.string = player.name + ` is going to take combat damage`
            ...
            this.flavorTextLable.string = stackEffect.attackingPlayer.name + ` is going to attack ${stackEffect.cardBeingAttacked.name}`
            ...
            this.flavorTextLable.string = stackEffect.rollingPlayer.name + ` is going to roll an attack against ${stackEffect.attackedMonster.name}`
        }
