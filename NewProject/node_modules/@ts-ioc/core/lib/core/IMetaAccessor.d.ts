 ...
 * @template T
 */
export declare class InjectMetaAccessorToken<T> extends RefRegistration<IMetaAccessor<T>> {
 ...
 * MetaAccessor token.
 */
export declare const MetaAccessorToken: InjectMetaAccessorToken<any>;
